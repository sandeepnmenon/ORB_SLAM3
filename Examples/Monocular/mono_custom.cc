...
void LoadImages(const string &strImagePath, const string &strPathTimes, const int num_frames,
...
int main(int argc, char **argv)
{
    ...
    if(argc < 4)
    {
        cerr << endl << "Usage: ./mono_custom path_to_vocabulary path_to_settings path_to_image_folder_1 path_to_times_file_1 number_frames_1 (path_to_image_folder_2 path_to_times_file_2 ... path_to_image_folder_N path_to_times_file_N) (trajectory_file_name)" << endl;
        return 1;
    }
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        LoadImages(string(argv[(2*seq)+3]), string(argv[(2*seq)+4]), num_frames, vstrImageFilenames[seq], vTimestampsCam[seq]);
        cout << "LOADED! " << vstrImageFilenames[seq].size()<<endl;
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            // cout<<"Loaded image "<<vstrImageFilenames[seq][ni]<<endl;
